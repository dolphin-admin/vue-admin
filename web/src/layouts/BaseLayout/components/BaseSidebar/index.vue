...
<template>
  <div
    class="bg-default-light dark:bg-default-dark absolute inset-y-0 left-0 z-[100] h-full border-y border-r border-gray-300 shadow-sm transition-[width] dark:border-gray-950 sm:static"
    :class="[
