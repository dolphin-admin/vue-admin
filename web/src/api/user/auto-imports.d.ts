...
export {}
declare global {
  const AuthAPI: (typeof import('../api/auth/index'))['AuthAPI']
  ...
  const PermissionUtils: (typeof import('../utils/permissions/index'))['PermissionUtils']
  ...
  const SiteUtils: (typeof import('../utils/site/index'))['SiteUtils']
  ...
  const RecordItem: (typeof import('../api/user/index'))['RecordItem']
  const UserTrafficAPI: (typeof import('../api/userTraffic/index'))['UserTrafficAPI']
  const UserTrafficUtils: (typeof import('../utils/userTraffic/index'))['UserTrafficUtils']
  ...
  const use2XL: (typeof import('../hooks/useMediaQuery/index'))['use2XL']
  ...
  const useLG: (typeof import('../hooks/useMediaQuery/index'))['useLG']
  const useLink: (typeof import('vue-router'))['useLink']
  const useLoading: (typeof import('../hooks/useLoading/index'))['useLoading']
  const useLoadingBar: (typeof import('naive-ui'))['useLoadingBar']
  const useMD: (typeof import('../hooks/useMediaQuery/index'))['useMD']
  const useMediaQuery: (typeof import('@vueuse/core'))['useMediaQuery']
  const useMessage: (typeof import('naive-ui'))['useMessage']
  const useMobile: (typeof import('../hooks/useMediaQuery/index'))['useMobile']
  const useNotification: (typeof import('naive-ui'))['useNotification']
  const useRoute: (typeof import('vue-router'))['useRoute']
  const useRouter: (typeof import('vue-router'))['useRouter']
  const useSM: (typeof import('../hooks/useMediaQuery/index'))['useSM']
