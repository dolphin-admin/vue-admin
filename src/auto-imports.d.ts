...
declare global {
  ...
  const FileUtils: typeof import('./utils/file')['FileUtils']
  const GlobalEnvConfig: typeof import('@/constants')['GlobalEnvConfig']
  const IconAPI: typeof import('./api/icon')['IconAPI']
  const IconUtils: typeof import('./utils/icon')['IconUtils']
  ...
  const SignupAPI: typeof import('./api/signup')['SignupAPI']
  const ThemeUtils: typeof import('./utils/theme')['ThemeUtils']
  const TimeUtils: typeof import('./utils/time')['TimeUtils']
  const UploadAPI: typeof import('./api/upload')['UploadAPI']
  const UserAPI: typeof import('./api/user')['UserAPI']
